...
export class AdminComponent {
  ...
  ModalTitle: string;
  ActivateAddEditItem: boolean=false;
  item: any;
  ...
  addClick() {
    this.item= {
      ...
      carModel:"",
      carYear: null,
      carPartName: "Total Vehicle",
      carPartType: "Total Vehicle",
      carImageDate: "",
      carImage1: "",
      carImage2: "",
      carImage3: "",
  ...
  closeClick() {
    this.ActivateAddEditItem=false;
    this.refreshInventory();
  }

  deleteClick(item: any, name:HTMLButtonElement) {
  ...
  closeModal() {
    let el: HTMLButtonElement = this.close.nativeElement;
    el.click();
  }
